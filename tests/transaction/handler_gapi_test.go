...
import (
	"context"
	transactondb "github.com/MamangRust/microservice-point-of-sale-transacton/database/schema"
	"testing"
...
func (s *TransactionGapiTestSuite) SetupSuite() {
	...
	transactonQueries := transactondb.New(s.DBPool())
	...
	repos := trans_repo.NewRepositories(transactonQueries, cashierClient, merchantClient, orderClient, orderItemClient)
